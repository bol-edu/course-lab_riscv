...
#define NOP ((RISCV_OPI_ADDI << 12) | RISCV_OPI);

#define RISCV_LUI 0x37 // opcode
#define RISCV_AUIPC 0x17

#define RISCV_JAL 0x6f // opcode
#define RISCV_JALR 0x67

#define RISCV_BR 0x63 // opcode

#define RISCV_LD 0x3 // opcode
#define RISCV_ST 0x23

#define RISCV_OPI 0x13 // opcode
#define RISCV_OP 0x33
// #define RISCV_OPIW 0x1b
// #define RISCV_OPW 0x3b

#define RISCV_BR_BEQ 0x0 // funct3
...
#define RISCV_OPI_ADDI 0x0 // funct3 // NOP
...
#define RISCV_OPI_SRI_SRAI 0x20 // [26:31]
#define RISCV_OPI_SRI_SRLI 0x0 // [26:31]

#define RISCV_OP_ADD 0x0 // funct3
...
#define RISCV_OP_ADD_ADD 0x0 // [26:31]
#define RISCV_OP_ADD_SUB 0x20 // [26:31]
#define RISCV_OP_SR_SRL 0x0 // [26:31]
#define RISCV_OP_SR_SRA 0x20 // [26:31]
...
#define RISCV_SYSTEM_ENV_ECALL 0x0 // unused
